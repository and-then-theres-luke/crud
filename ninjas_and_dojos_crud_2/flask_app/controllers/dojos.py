...
def update_ninja_frontend(id):
    one_ninja = ninja.Ninja.get_one_ninja({'id' : id})
    return render_template("update_ninja.html", one_ninja = one_ninja)

@classmethod
@app.route("/ninjas/update/process", methods=["POST"])
def update_ninja_frontend_process():
